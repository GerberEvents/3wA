 ...
 */
 ...
 {
         brand       : 'Citroen',
         buyDate     : new Date ('2014-04-12'),
         passengers  : ['David','Audrey','Charlie','Emma'],
         year        : 2010
 };
...
document.write('<li>Marque : ' + youCar.brand + '</li>');
document.write('<li>Année de fabrication : ' + youCar.year + '</li>');

/*
 * Utilisation de la méthode toDateString() des objets de la classe Date
 * afin d'obtenir une chaîne de caractères avec une date lisible.
 */
document.write("<li>Date de l'achat : " + youCar.buyDate.toDateString() + '</li>');

// myCar est un objet qui contient une propriété buyDate qui est un objet de la classe Date.

document.write('<li>Passager 1 : ' + youCar.passengers[0] + '</li>');
document.write('<li>Passager 2 : ' + youCar.passengers[1] + '</li>');
document.write('<li>Passager 1 : ' + youCar.passengers[2] + '</li>');
document.write('<li>Passager 2 : ' + youCar.passengers[3] + '</li>');
